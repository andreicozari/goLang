...
There may be memory that needs to be shared between multiple concurrent
...
memory. You can request a lock for reading, in which case you will be
...
holding a writer lock. Here’s an example that demonstrates a producer that is
less active than the numerous consumers the code creates:
*/
func main() {
